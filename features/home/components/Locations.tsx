            ...
            <div className="wrapper">
                ...
                <div className="locations-section__grid">
                    ...
                    <div className="location-card">
                        ...
                        <div className="location-card__map">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d41010.71662738961!2d21.95900335781476!3d50.02691423259031!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x473cfd8cadbe5765%3A0xe6b3494c09239b65!2sPanda%20Masa%C5%BC!5e0!3m2!1spl!2spl!4v1768559752430!5m2!1spl!2spl"
                                width="100%"
                                height="350"
                                style={{ border: 0 }}
                                allowFullScreen
